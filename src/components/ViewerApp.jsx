...
function RightRail() {
  ...
  // The same tabs `RightPanel` renders, in the same order — the rail is the collapsed form of that
  // bar, so an entry here that is missing there opens an empty slot, and one missing here is a tab
  // you cannot reach once the rail is all you have. Keep the two lists in step.
  const tabs = [
    {
      id: 'workspace',
