// Vendored from the OHIF Viewer — platform/ui-next/src/components/Tooltip/Tooltip.tsx
// at OHIF/Viewers v3.10.0-beta.151 (4e09f85d5), MIT License,
// Copyright (c) 2018 Open Health Imaging Foundation.
//
// One edit from upstream: the `cn` import path now points at this repo's @/lib/utils.
//
// DataRow reaches for a tooltip in three places — a long title, a details block over four lines,
// and the overflow marker — so it comes in with it. `bg-primary-dark` and `border-secondary-light`
// are OHIF theme names declared in tailwind.config.js.
