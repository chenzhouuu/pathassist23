...
_SYSTEM = (
    ...
    "highlight) to direct attention, and data tools — segmentation and counting to measure, "
    "region description to read morphology. "
    ...
    "drilling to a higher magnification, and do not over-call describe_region — a few "
    "well-chosen regions beat many. "
    "All coordinates are image / level-0 pixels. When a "
